...
const CourseInfoComponent = () => {
  ...
  const statsData = [
    ...
    {
      number:
        "Final-year students, postgraduates, & young professionals",
      label: "Eligibility",
    },
    {
      number: "14,999",
  ...
  return (
    <div className="w-full mx-auto py-6 space-y-8">
      {/* Statistics Section */}
      <div className="flex flex-col md:flex-row justify-center items-center text-left pt-5">
        {statsData.map((stat, index) => (
          <div key={index} className="relative px-16">
            <p className="mt-2 text-gray-600 font-semibold text-2xl italic"
            style={{
